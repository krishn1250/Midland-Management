...
import com.school.midland.admin.security.JwtAuthFilter;
...
//                        .requestMatchers("/midland/admin/students/all").permitAll()
                        ...
                        .requestMatchers("/midland/admin/**").hasRole("ADMIN")
                                .requestMatchers("/midland/user/schools/create").hasRole("ADMIN")
                                .requestMatchers("/midland/admin/**").hasRole("ADMIN")
